#ifndef XMPM_HEXAHEDRON_ELEMENT_H_
#define XMPM_HEXAHEDRON_ELEMENT_H_
...
class HexahedronElementXMPM : public Element<Tdim> {
 ...
 public:
  ...
  HexahedronElementXMPM() : mpm::Element<Tdim>() {
...
#include "hexahedron_xmpm_element.tcc"

#endif  // XMPM_HEXAHEDRON_ELEMENT_H_
